...
if test -n "$STAGING_DIR"; then
	...
	: ${EGREP="/data/patch_18.06.5/openwrt/staging_dir/host/bin/grep -E"}
	: ${FGREP="/data/patch_18.06.5/openwrt/staging_dir/host/bin/grep -F"}
	: ${GREP="/data/patch_18.06.5/openwrt/staging_dir/host/bin/grep"}
	: ${SED="/data/patch_18.06.5/openwrt/staging_dir/host/bin/sed"}
fi
